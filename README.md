...
|[Private Link](https://azure.microsoft.com/en-us/services/private-link/)|`enable_private_link`|PowerShell 7
...
|Limits access to PaaS services to essential admin IPs, Virtual Networks|`restrict_public_access`|None|
