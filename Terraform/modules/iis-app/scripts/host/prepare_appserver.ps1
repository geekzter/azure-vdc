...
& $env:TEMP\bootstrap_windows.ps1 -Packages None -PowerShell $true
...
& $env:TEMP\install_agent.ps1 -Environment $config.environment -Organization $config.organization -Project $config.project -PAT $config.pat
