...
locals {
  ...
  iaas_app_fqdn                = var.use_vanity_domain_and_ssl ? azurerm_dns_cname_record.waf_iaas_app_cname[0].fqdn : azurerm_public_ip.waf_pip.fqdn
  iaas_app_url                 = "${var.use_vanity_domain_and_ssl ? "https" : "http"}://${local.iaas_app_fqdn}/"
  paas_app_fqdn                = var.use_vanity_domain_and_ssl ? azurerm_dns_cname_record.waf_paas_app_cname[0].fqdn : azurerm_public_ip.waf_pip.fqdn
